...
>
> This is the **original design specification**, written before the project was built and kept
> only as a record of intent. Substantial parts describe an app that does not exist: a
> validation view, recipe favourites, `prompts/json-schema.md`, LLM-authored nutrition, and
> single-pass generation with self-review.
>
> The scope and non-goals that *do* still hold have been carried forward to
> [SPEC.md](../SPEC.md). Read that instead.
>
